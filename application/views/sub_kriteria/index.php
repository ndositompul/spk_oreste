			...
			<div class="modal-content">
				...
				<?= form_open('Sub_kriteria/store') ?>
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-success btn-sm btn-rounded"><i class="fa fa-save"></i> Simpan</button>
					</div>
				<?php echo form_close() ?>
			</div>
		</div>
			...
			<table class="table table-bordered" width="100%" cellspacing="0">
				...
				<tbody>
					...
					<tr align="center">
						...
						<td><?= $key['nilai'] ?></td>
						<td>
							<a data-toggle="modal" title="Edit Data" href="#editsk<?= $key['id_sub_kriteria'] ?>" class="btn btn-warning btn-sm  btn-circle"><i class="fa fa-edit"></i></a>
							<a  data-toggle="tooltip" data-placement="bottom" title="Hapus Data" href="<?= base_url('Sub_kriteria/destroy/'.$key['id_sub_kriteria']) ?>" onclick="return confirm ('Apakah anda yakin untuk meghapus data ini')" class="btn btn-danger btn-sm  btn-circle"><i class="fa fa-trash"></i></a>
						</td>
					</tr>
