...
<div class="card shadow mb-4">
    <div class="card-header py-3">
		<div class="row">
        <h6 class="ml-3 mt-2 font-weight-bold text-dark"><i class="fas fa-fw fa-edit"></i> Edit Data User</h6>
		<a href="<?= base_url('User'); ?>" class="btn btn-warning btn-sm btn-icon-split ml-auto"><span class="icon text-white-50"><i class="fas fa-arrow-left"></i></span>
